	...
	public class MachineInformation
	{
		...
		public class CPU
		{
			...
			public enum ExtendedFeatureFlagsF7ECX : uint
			{
				...
				RESERVED7 = 0b100000000000000000000000000000,
				SGX_LC = 0b1000000000000000000000000000000,
				RESERVED8 = 0b10000000000000000000000000000000
			}
			...
			public enum ExtendedFeatureFlagsF7EDX : uint
			{
				...
				RESERVED16 = 0b10000000000000000000,
				IBT = 0b100000000000000000000,
				RESERVED17 = 0b1000000000000000000000,
				RESERVED18 = 0b10000000000000000000000,
				RESERVED19 = 0b100000000000000000000000,
				RESERVED20 = 0b1000000000000000000000000,
				RESERVED21 = 0b10000000000000000000000000,
				IBRS_IBPB_IBC = 0b100000000000000000000000000,
				STIBP = 0b1000000000000000000000000000,
				RESERVED22 = 0b10000000000000000000000000000,
				CAPABILITIES = 0b100000000000000000000000000000,
				RESERVED23 = 0b1000000000000000000000000000000,
